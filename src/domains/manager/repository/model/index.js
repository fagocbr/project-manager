 ...
 * @type {string}
 */
export const label = 'Repositório'

/**
 * @type {string}
 */
export const title = 'Cadastro de Repositórios'

/**
 * @type {string}
 */
export const tooltip = 'Os Repositórios são as fontes de dados para gerenciar'

/**
 * @type {string}
 */
export const description = 'Com o Cadastro de Repositórios é possível gerir os fluxos de produtos de trabalho da aplicação'
 ...
 * @type {string}
 */
export const path = '/dashboard/manager/repository'

/**
 * @type {string}
 */
export const namespace = 'manager.repository'
...
export const fields = (scope, route = null) => {
  return model.filter(
    [
      ...
      model.field('name', 'Nome').$text().$render(),
